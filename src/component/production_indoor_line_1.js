...
const ProductionIndoorLine1 = () => {
  ...
  useEffect(() => {
    ...
    const list_data = () => {
      indoor_line()
        .then((res) => {
          const data_list = res.filter((item) => item.unitLine === "1");
    ...
    <div className="summary-container h-100">
      ...
      <div id="content">
        <h2 className="text-center mt-4 mb-0">
          <b>PRODUCTION STATUS</b> INDOOR UNIT LINE 1
        </h2>
              ...
              <thead>
                <tr>
                  ...
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 1 ประกอบโบลเวอร์และมอร์เตอร์
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 2 ประกอบชุดคอยล์
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 3 ประกอบชุดถาดรางน้ำ
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 4 กล่องคอนโทรลเคลื่อนที่มีการเชื่อมต่ออินเตอร์เน็ต
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 5 การทดสอบการทำงานของระบบเชื่อมต่ออินเตอร์เน็ต
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 6 การประกอบฝาหน้าและใส่ฟิวเตอร์
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 7 การทดสอบที่ห้องทดสอบ
                  </th>
                  <th colSpan="4" className="align-middle">
                    สถานีที่ 8 Packing
                  </th>
...
export default ProductionIndoorLine1;
